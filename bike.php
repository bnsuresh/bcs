...
<html lang="en">
 ...
 -->
    ...
    <script language="javascript" type="text/javascript">
               ...
               ajaxRequest.open("GET", "cmt.php", true);
...
if(isset($_GET['bk'])){
  ...
  $bk=$_GET['bk'];
  $_SESSION['url']='bike.php?bk='.$bk;
  $_SESSION['bk']=$bk;
  $q=$mysqli->query("select * from bike where id=$bk");
...
if(isset($_POST['cmt'])){
  ...
  $q=$mysqli->query("insert into comment (`puid`,`bid`,`cmt`) values('$puid','$bk','$cmt')");
