...
<html lang="en">
      ...
      <div class="row">
        ...
        <div class="col-lg-9">
         ...
         <!-- <div id="carouselExampleIndicators" class="carousel slide my-4" data-ride="carousel">
          ...
          $q=$mysqli->query("select * from bike");
          $c=$q->num_rows;
          if($c<0){
          ...
          while($qu=mysqli_fetch_array($q)){
            ...
            <div class="col-lg-4 col-md-6 mb-4">
              <div class="card h-100">
                <a href="bike.php?bk='.$bid.'"><img class="card-img-top" src="'.$img.'" alt=""></a>
                <div class="card-body">
                  <h4 class="card-title">
                    <a href="bike.php?bk='.$bid.'">'.$bnm.'</a>
                  </h4>
                  <h5>₹'.$cost.'</h5>
 ...
 <!--           <div class="col-lg-4 col-md-6 mb-4">
        ...
        if(isset($_GET['cat'])){
          ...
          $q=$mysqli->query("select * from bike where catid=$cid");
          $c=$q->num_rows;
          if($c<0){
            echo '<h4>No Bikes Available with this Category</h4>';
          }
